...
<div class="container">
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-around align-items-center">
      <div class="col-4">
        <a class="search link-secondary" href="#">Subscribe</a>
      </div>
      ...
      <div class="col-4 d-flex justify-content-end align-items-center">
        ...
        %>
         <%=session.getAttribute("userID") %>님 환영합니다.
         <a class="btn btn-sm mx-1 btn-outline-secondary" href="/pr/main.jsp">메인으로</a>
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between">
      <a class="p-2 link-secondary" href="/pr/culture.jsp">Culture</a>
